...
-- VERSION: 1.1 (Refined 3NF Architecture)
-- =============================================================================
...
-- DROP TABLE IF EXISTS dim_budget_goals CASCADE;
-- DROP TABLE IF EXISTS dim_categories CASCADE;
-- DROP TABLE IF EXISTS dim_wallets CASCADE;
-- DROP TYPE IF EXISTS transaction_sentiment_enum CASCADE;
...
CREATE TABLE fact_transactions (
    ...
    created_by_fk uuid NOT NULL REFERENCES auth.users(id), e
